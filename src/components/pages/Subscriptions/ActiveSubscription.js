...
const [activeOption, setActiveOption] = useState("Active Subscriptions");
        ...
        {activeOption === "Active Subscriptions" && (
          ...
          <TableBody>
            <TableRow>
              ...
              <TableBodyData>
              <TableText variant={{ type: "simple", status: "active" }}>Active</TableText>
              </TableBodyData>
            </TableRow>
            <TableRow>
              <TableBodyData>
            ...
            <TableRow>
              ...
              <TableBodyData>
              <TableText variant={{ type: "simple", status: "paid" }}>Active</TableText>
              </TableBodyData>
            </TableRow>
